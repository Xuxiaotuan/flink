...
/** Internal options for the native lineage POC. */
@Internal
public final class PlannerLineageOptions {
    public static final ConfigOption<Boolean> ENABLED =
            ConfigOptions.key("table.lineage.enabled")
                    .booleanType()
                    .defaultValue(true)
                    .withDescription(
                            "Observe native logical SQL lineage without vetoing execution.");

    private PlannerLineageOptions() {}
}
